 ...
 * @property {import('../build/playcanvas').AppBase} app - Application.
 * @property {import('../build/playcanvas').Entity} player - Player entity.
 * @property {import('../build/playcanvas').Entity|null} cameraEntity - Camera entity.
 * @property {import('../build/playcanvas').Vec3} spawn - Spawn position (mutated by the sliders).
